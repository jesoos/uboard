...
<div id="content_pop">
	...
	<div id="title">
		<ul>
			<li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>" alt=""/> List Sample </li>
		</ul>
	</div>
	<!-- // 타이틀 -->
	<div id="search">
		<ul>
			...
			<li><label for="searchKeyword" style="visibility:hidden;display:none;">검색어 입력</label><form:input path="searchKeyword" cssClass="txt"/></li>
			<li>
