...
public class SampleDAO extends EgovAbstractDAO {
    ...
    public String insertTask(SampleVO vo) throws Exception {
        return (String)insert("sampleDAO.insertTask", vo);
    }
	...
	public int selectSampleListTotCnt(SampleDefaultVO searchVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("sampleDAO.selectSampleListTotCnt", searchVO);
    }
...
//        return list("sampleDAO.selectUnitList", searchVO);
//    }
    
	public String getUserPwd(String userid) {
		return (String)selectByPk("sampleDAO.getUserPwd",userid);
	}
}
